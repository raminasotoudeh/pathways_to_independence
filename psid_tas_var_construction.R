...
# This script constructs longitudinal variables from PSID TA data across multiple waves
# and merges with individual and family data to create a comprehensive dataset
...
# 2005
parents$dad_income_2005 = income_sub$fam_income_last_yr_2005[match(parents$dad_UID, income_sub$UID_2)]
parents$mom_income_2005 = income_sub$fam_income_last_yr_2005[match(parents$mom_UID, income_sub$UID_2)]
...
parents$dad_wealth_no_equity_2005 = all$wealth_no_equity_2005[match(parents$dad_UID, all$UID)]
parents$mom_wealth_no_equity_2005 = all$wealth_no_equity_2005[match(parents$mom_UID, all$UID)]
...
parents$dad_wealth_w_equity_2005 = all$wealth_w_equity_2005[match(parents$dad_UID, all$UID)]
parents$mom_wealth_w_equity_2005 = all$wealth_w_equity_2005[match(parents$mom_UID, all$UID)]
...
# 2007
parents$dad_income_2007 = income_sub$fam_income_last_yr_2007[match(parents$dad_UID, income_sub$UID_2)]
parents$mom_income_2007 = income_sub$fam_income_last_yr_2007[match(parents$mom_UID, income_sub$UID_2)]
...
parents$dad_wealth_no_equity_2007 = all$wealth_no_equity_2007[match(parents$dad_UID, all$UID)]
parents$mom_wealth_no_equity_2007 = all$wealth_no_equity_2007[match(parents$mom_UID, all$UID)]
...
parents$dad_wealth_w_equity_2007 = all$wealth_w_equity_2007[match(parents$dad_UID, all$UID)]
parents$mom_wealth_w_equity_2007 = all$wealth_w_equity_2007[match(parents$mom_UID, all$UID)]
...
# 2009
parents$dad_income_2009 = income_sub$fam_income_last_yr_2009[match(parents$dad_UID, income_sub$UID_2)]
parents$mom_income_2009 = income_sub$fam_income_last_yr_2009[match(parents$mom_UID, income_sub$UID_2)]
...
parents$dad_wealth_no_equity_2009 = all$wealth_no_equity_2009[match(parents$dad_UID, all$UID)]
parents$mom_wealth_no_equity_2009 = all$wealth_no_equity_2009[match(parents$mom_UID, all$UID)]
...
parents$dad_wealth_w_equity_2009 = all$wealth_w_equity_2009[match(parents$dad_UID, all$UID)]
parents$mom_wealth_w_equity_2009 = all$wealth_w_equity_2009[match(parents$mom_UID, all$UID)]
...
#2011
parents$dad_income_2011 = income_sub$fam_income_last_yr_2011[match(parents$dad_UID, income_sub$UID_2)]
parents$mom_income_2011 = income_sub$fam_income_last_yr_2011[match(parents$mom_UID, income_sub$UID_2)]
...
parents$dad_wealth_no_equity_2011 = all$wealth_no_equity_2011[match(parents$dad_UID, all$UID)]
parents$mom_wealth_no_equity_2011 = all$wealth_no_equity_2011[match(parents$mom_UID, all$UID)]
...
parents$dad_wealth_w_equity_2011 = all$wealth_w_equity_2011[match(parents$dad_UID, all$UID)]
parents$mom_wealth_w_equity_2011 = all$wealth_w_equity_2011[match(parents$mom_UID, all$UID)]
...
# 2013
parents$dad_income_2013 = income_sub$fam_income_last_yr_2013[match(parents$dad_UID, income_sub$UID_2)]
parents$mom_income_2013 = income_sub$fam_income_last_yr_2013[match(parents$mom_UID, income_sub$UID_2)]
...
parents$dad_wealth_no_equity_2013 = all$wealth_no_equity_2013[match(parents$dad_UID, all$UID)]
parents$mom_wealth_no_equity_2013 = all$wealth_no_equity_2013[match(parents$mom_UID, all$UID)]
...
parents$dad_wealth_w_equity_2013 = all$wealth_w_equity_2013[match(parents$dad_UID, all$UID)]
parents$mom_wealth_w_equity_2013 = all$wealth_w_equity_2013[match(parents$mom_UID, all$UID)]
...
# 2015
parents$dad_income_2015 = income_sub$fam_income_last_yr_2015[match(parents$dad_UID, income_sub$UID_2)]
parents$mom_income_2015 = income_sub$fam_income_last_yr_2015[match(parents$mom_UID, income_sub$UID_2)]
...
parents$dad_wealth_no_equity_2015 = all$wealth_no_equity_2015[match(parents$dad_UID, all$UID)]
parents$mom_wealth_no_equity_2015 = all$wealth_no_equity_2015[match(parents$mom_UID, all$UID)]
...
parents$dad_wealth_w_equity_2015 = all$wealth_w_equity_2015[match(parents$dad_UID, all$UID)]
parents$mom_wealth_w_equity_2015 = all$wealth_w_equity_2015[match(parents$mom_UID, all$UID)]
...
# 2017
parents$dad_income_2017 = income_sub$fam_income_last_yr_2017[match(parents$dad_UID, income_sub$UID_2)]
parents$mom_income_2017 = income_sub$fam_income_last_yr_2017[match(parents$mom_UID, income_sub$UID_2)]
...
parents$dad_wealth_no_equity_2017 = all$wealth_no_equity_2017[match(parents$dad_UID, all$UID)]
parents$mom_wealth_no_equity_2017 = all$wealth_no_equity_2017[match(parents$mom_UID, all$UID)]
...
parents$dad_wealth_w_equity_2017 = all$wealth_w_equity_2017[match(parents$dad_UID, all$UID)]
parents$mom_wealth_w_equity_2017 = all$wealth_w_equity_2017[match(parents$mom_UID, all$UID)]
...
# 2019
parents$dad_income_2019 = income_sub$fam_income_last_yr_2019[match(parents$dad_UID, income_sub$UID_2)]
parents$mom_income_2019 = income_sub$fam_income_last_yr_2019[match(parents$mom_UID, income_sub$UID_2)]
...
parents$dad_wealth_no_equity_2019 = all$wealth_no_equity_2019[match(parents$dad_UID, all$UID)]
parents$mom_wealth_no_equity_2019 = all$wealth_no_equity_2019[match(parents$mom_UID, all$UID)]
...
parents$dad_wealth_w_equity_2019 = all$wealth_w_equity_2019[match(parents$dad_UID, all$UID)]
parents$mom_wealth_w_equity_2019 = all$wealth_w_equity_2019[match(parents$mom_UID, all$UID)]
...
# 2021
parents$dad_income_2021 = income_sub$fam_income_last_yr_2021[match(parents$dad_UID, income_sub$UID_2)]
parents$mom_income_2021 = income_sub$fam_income_last_yr_2021[match(parents$mom_UID, income_sub$UID_2)]
...
parents$dad_wealth_no_equity_2021 = all$wealth_no_equity_2021[match(parents$dad_UID, all$UID)]
parents$mom_wealth_no_equity_2021 = all$wealth_no_equity_2021[match(parents$mom_UID, all$UID)]
...
parents$dad_wealth_w_equity_2021 = all$wealth_w_equity_2021[match(parents$dad_UID, all$UID)]
parents$mom_wealth_w_equity_2021 = all$wealth_w_equity_2021[match(parents$mom_UID, all$UID)]
...
# poverty threshold
poverty_threshold = read_excel("./poverty_threshold/poverty.xlsx")
poverty_threshold$UID_2 = paste0(poverty_threshold$ER30001, "_", poverty_threshold$ER30002)

poverty_threshold$poverty_threshold_2005 = poverty_threshold$ER28039
poverty_threshold$poverty_threshold_2007 = poverty_threshold$ER41029
poverty_threshold$poverty_threshold_2009 = poverty_threshold$ER46972
poverty_threshold$poverty_threshold_2011 = poverty_threshold$ER52396
poverty_threshold$poverty_threshold_2013 = poverty_threshold$ER58213
poverty_threshold$poverty_threshold_2015 = poverty_threshold$ER65449
poverty_threshold$poverty_threshold_2017 = poverty_threshold$ER71528
poverty_threshold$poverty_threshold_2019 = poverty_threshold$ER77589
poverty_threshold$poverty_threshold_2021 = poverty_threshold$ER81916

poverty_threshold = poverty_threshold[,c('UID_2', grep('poverty_threshold',colnames(poverty_threshold), value = T))]
poverty_threshold_melt = melt(poverty_threshold, id.vars = "UID_2")
poverty_threshold_melt$year = as.numeric(gsub("poverty_threshold_", "", poverty_threshold_melt$variable))
poverty_threshold_melt = poverty_threshold_melt[,c('UID_2', 'year', 'value')]

colnames(poverty_threshold_melt) = c('UID_2', 'year', 'poverty_threshold_psid')
all = left_join(all, poverty_threshold_melt) 

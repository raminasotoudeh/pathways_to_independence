...
# Subset the data to include only complete sequences
...
# People who have empty sequences
...
# Combine both projected and non-projected individuals into a single data set
...
# Construct fam income quintiles
...
# Set the desired order for variables
...
########### 
# Multinomial regression but with sibling fixed effects
###########
